    ...
    def __call__(self, execTime):
        ...
        while time.time() - beginTime < execTime:
            ...
            if self.state == 0:
                ...
                error = abs(self.pepper.getAnglesPosition("RShoulderPitch") - target)
            ...
            # Moves the arm to right direction rotating the shoulder
                ...
                error = abs(self.pepper.getAnglesPosition("RShoulderRoll") - target)
                if error < 1e-2 : 
                    self.state = 2
            ...
            # Bend the elbow to 90 degree (first waving step)
                ...
                error = abs(self.pepper.getAnglesPosition("RElbowRoll") - target)
                if error < 1e-2 : 
                    self.state = 4
